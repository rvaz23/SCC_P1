...
public class CognitiveSearch {
    public static final String SEARCHSERVICEQUERYKEY = "736DB28373B6849B763051590ABEA67A";//System.getenv("SearchServiceQueryKey");//
    public static final String INDEXNAME = "cosmosdb-index";//System.getenv("IndexName");//
    public static final String SEARCHSERVICE_URL = "https://scc2021rv.search.windows.net/";// System.getenv("SearchServiceUrl");//
